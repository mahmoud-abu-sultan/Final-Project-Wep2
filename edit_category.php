...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if (count($errors) > 0) {
    ...
    $query = "UPDATE category SET name='$name', descreption='$descreption' WHERE id='" . $_GET['id'] . "'";
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="projectinput1" class="form-control" placeholder="Category Name" name="c_name" value="<?php echo $row['name'] ?>">
                              <?php
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="projectinput2" class="form-control" placeholder="Category Descreption" name="c_descreption" value="<?php echo $row['descreption'] ?>">
                              <?php
