...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=926291556ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=category">`final_project`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=categors">`project`.`categors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=user">`final_project`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=final_project&table=shops">`final_project`.`shops`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=product_file">`project`.`product_file`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=product">`project`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=student">`students`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=course">`students`.`course`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=Course">`students`.`Course`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=students&table=registration">`students`.`registration`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5f392c4d7370564744233e6a2e3a446c">
